...
class ChatServicer(rpc.ChatServicer):
    ...
    def Login(self, request, context):
        logging.info("Login chamado em {}".format(time.strftime("%d-%m-%Y %H:%M:%S +0000", time.gmtime())))
    ...
    def Send(self, request, context):
        logging.info("Enviar chamado em {}".format(time.strftime("%d-%m-%Y %H:%M:%S +0000", time.gmtime())))
        self.chats.append(request)

        return chat.Empty()

    def Stream(self, request, context):
        logging.info("ChatStream chamado em {}".format(time.strftime("%d-%m-%Y %H:%M:%S +0000", time.gmtime())))
        lastindex = 0
...
def serve():
    logging.info("Servidor iniciou às {}".format(time.strftime("%d-%m-%Y %H:%M:%S +0000", time.gmtime())))
    ...
    try:
        ...
        logging.info("Servidor encerrou às {}".format(time.strftime("%d-%m-%Y %H:%M:%S +0000", time.gmtime())))
